...
Report 50439 "Un Allocated"
{
    ...
    dataset
    {
        dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
        {
            ...
            column(Amount_MemberLedgerEntry; "Cust. Ledger Entry"."Transaction Amount")
            {
            }
            ...
            begin
                memberledger.Reset;
                memberledger.SetRange(memberledger."Customer No.", "Cust. Ledger Entry"."Customer No.");
                //memberledger.SETRANGE(memberledger."Transaction Type"
                if memberledger.Find('-') then begin
                    "Cust. Ledger Entry"."Transaction Amount" := memberledger.Amount;
                end;
            end;
